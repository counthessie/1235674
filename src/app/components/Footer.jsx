        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <h2 className="text-2xl font-bold text-white">Mert<span className="text-code-green">.</span></h2>
              <p className="text-gray-400 mt-2">Web Developer</p>
            </div>
            
            <div className="flex flex-col items-center md:items-end">
              <h3 className="text-xl font-semibold text-white mb-4">İletişim</h3>
              <a href="mailto:mert@example.com" className="text-gray-400 hover:text-code-green mb-2 transition-colors">
                mert@example.com
              </a>
          ...
          <div className="mt-12 text-center text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} Mert. Tüm hakları saklıdır.
          </div>
        </div>
      </footer>
    );
